...
export default function Header({ hideSidebar, mobileOpened, desktopOpened, toggleMobile, toggleDesktop }) {
    const navigate = useNavigate()

    const headerTrans = useSelector(e => e?.languageSliceReducer?.languageData[0]?.header)
    ...
    return (
        <div
            className="flex border border-rose-500 mx-[100px] my-[34px] justify-between"
        >

            {!hideSidebar && <><Burger opened={mobileOpened} onClick={toggleMobile} hiddenFrom="sm" size="sm" />
